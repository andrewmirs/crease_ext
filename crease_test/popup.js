...
document.addEventListener('DOMContentLoaded', () => {
      chrome.tabs.getSelected(null, function(tab){
          ...
          console.log(currentURL, currentTitle, currentFavIcon)
          url = tab.url;
          title = tab.title;
...
function processForm() {
  ...
  console.log("Bookmark/Alarm Data Object:", returnObj);
  return returnObj;
}
...
function findFavicon(){
  $("a[href^='http']").each(function() {
    $(this).append('<img src="https://www.google.com/s2/favicons?domain=' + this.href + '">');
  });
}
